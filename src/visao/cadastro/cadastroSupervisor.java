...
public class cadastroSupervisor extends javax.swing.JFrame {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        supervisor.setMatricula_sup(txtMatricula.getText());
        supervisor.setNome(txtNome.getText());
        supervisor.setCpf(txtCpf.getText());
        
        SupervisorDao supervisordao=new SupervisorDao();
        supervisordao.conectar();

        if(supervisordao.verifica(supervisor.getMatricula_sup())){
            JOptionPane.showMessageDialog(null,"Esse supervisor já está cadastrado!");
            
        }else{
            supervisordao.salvar(supervisor);
            JOptionPane.showMessageDialog(null,"Supervisor Cadastrado com sucesso!");
        }
        supervisordao.desconectar();
        dispose(); 
