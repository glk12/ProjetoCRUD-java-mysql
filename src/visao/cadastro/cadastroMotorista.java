...
public class cadastroMotorista extends javax.swing.JFrame {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        motorista.setMatricula_mot(txtMatricula.getText());
        motorista.setNome(txtNome.getText());
        motorista.setCpf(txtCpf.getText());

        MotoristaDao motoristadao=new MotoristaDao();
        motoristadao.conectar();

        if(motoristadao.verifica(motorista.getMatricula_mot())){
            JOptionPane.showMessageDialog(null,"Esse Motorista já está cadastrado!");

        }else{
            motoristadao.salvar(motorista);
            JOptionPane.showMessageDialog(null,"Motorista Cadastrado com sucesso!");
        }
        motoristadao.desconectar();
        dispose();
